...
class OutputPort extends Port {
  ...
  async send(data) {
    ...
    // Usa o primeiro binding para transmitir os dados
    await this.bindings[0].transmit(data);
    return true;
  }
}
  ...
  const bindingConfigs = [
    {
      ...
      condition: (data) => data.type === 'FahrenheitTemperature' 
    },
    {
      sourceComponent: boundaryComp,
      sourcePort: outputPort,
      ...
      condition: (data) => data.type === 'Boolean' 
    }
  ];
