...
class SysADLModel extends Model {
  constructor(){
    ...
    this.addExecutableSafe("SysADLModel.pwk0", "executable FarToCelEX to FarToCelAN", []);
    this.addExecutableSafe("SysADLModel.0h54", "executable CalcAverageEX to TempMonitorAN", []);
