...
class SysADLModel extends Model {
  constructor(){
    ...
    if (!this.SystemCP.tempMon.ports["average"]) { const __p = new Port("average", "out", { owner: "tempMon" }); this.SystemCP.tempMon.addPort(__p); }
    ...
    this.addExecutableSafe("SysADLModel.zlib", "executable FarToCelEX to FarToCelAN", []);
    this.addExecutableSafe("SysADLModel.823q", "executable CalcAverageEX to TempMonitorAN", []);
