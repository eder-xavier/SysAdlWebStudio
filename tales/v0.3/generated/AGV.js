...
class CP_ComponentsAGV_SupervisorySystem extends Component {
  constructor(name, opts={}) {
      ...
      this.addPort(new PT_PortsAGV_ISupervisorySystem("in_outData", { owner: name }));
    }
}
class CP_ComponentsAGV_AGVSystem extends Component {
  constructor(name, opts={}) {
      ...
      this.addPort(new PT_PortsAGV_IAGVSystem("in_outData", { owner: name }));
    }
}
...
class SysADLArchitecture extends Model {
  constructor(){
    ...
    this.addExecutableSafe("SysADLArchitecture.4fc6", "executable CompareStationsEX to CompareStationsAN", []);
    this.addExecutableSafe("SysADLArchitecture.lm6v", "executable ControlArmEX to ControlArmAN", []);
    this.addExecutableSafe("SysADLArchitecture.pb3z", "executable NotifierArmEX to NotifierArmAN", []);
    this.addExecutableSafe("SysADLArchitecture.g0lw", "executable NotifyAGVFromMotorEX to NotifyAGVFromMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.0idh", "executable NotifySupervisoryFromMotorEX to NotifySupervisoryFromMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.olop", "executable PassedMotorEX to PassedMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.jw9r", "executable SendCommandEX to SendCommandAN", []);
    this.addExecutableSafe("SysADLArchitecture.dfvw", "executable SendCurrentLocationEX to SendCurrentLocationAN", []);
    this.addExecutableSafe("SysADLArchitecture.qp06", "executable SendDestinationEX to SendDestinationAN", []);
    this.addExecutableSafe("SysADLArchitecture.q8tv", "executable SendStartMotorEX to SendStartMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.qfym", "executable StopMotorEX to StopMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.a6p7", "executable VehicleTimerEX to VehicleTimerAN", []);
    ...
    const CN_dataExchange_1 = new CN_ConnectorsAGV_interactionAGVAndSupervisory("dataExchange");
    this.addConnector(CN_dataExchange_1);
    const CN_updateStatus_4 = new CN_ComponentsAGV_status("updateStatus");
    this.addConnector(CN_updateStatus_4);
    const CN_arrived_7 = new CN_ConnectorsAGV_locationVehicle("arrived");
    this.addConnector(CN_arrived_7);
    const CN_ackArm_10 = new CN_ConnectorsAGV_notificationArm("ackArm");
    this.addConnector(CN_ackArm_10);
    const CN_cmdArm_13 = new CN_ConnectorsAGV_commandArm("cmdArm");
    this.addConnector(CN_cmdArm_13);
    const CN_ackMotor_16 = new CN_ConnectorsAGV_notificationMotor("ackMotor");
    this.addConnector(CN_ackMotor_16);
    const CN_cmdMotor_19 = new CN_ConnectorsAGV_commandMotor("cmdMotor");
    this.addConnector(CN_cmdMotor_19);
    const CN_destinationStation2_22 = new CN_ConnectorsAGV_locationVehicle("destinationStation2");
    this.addConnector(CN_destinationStation2_22);
    const CN_destinationStation_25 = new CN_ConnectorsAGV_locationVehicle("destinationStation");
    this.addConnector(CN_destinationStation_25);
    const CN_command_28 = new CN_ConnectorsAGV_commandArm("command");
    this.addConnector(CN_command_28);
    const CN_command2_31 = new CN_ConnectorsAGV_commandArm("command2");
    this.addConnector(CN_command2_31);
    const CN_currentLocation_34 = new CN_ConnectorsAGV_locationVehicle("currentLocation");
    this.addConnector(CN_currentLocation_34);
    const CN_sendNotificationMotor_37 = new CN_ConnectorsAGV_notificationMotor("sendNotificationMotor");
    this.addConnector(CN_sendNotificationMotor_37);
    const CN_sendNotificationMotor2_40 = new CN_ConnectorsAGV_notificationMotor("sendNotificationMotor2");
    this.addConnector(CN_sendNotificationMotor2_40);
    const CN_arrived_43 = new CN_ConnectorsAGV_locationVehicle("arrived");
    this.addConnector(CN_arrived_43);
    const CN_ackArm_46 = new CN_ConnectorsAGV_notificationArm("ackArm");
    this.addConnector(CN_ackArm_46);
    const CN_cmdArm_49 = new CN_ConnectorsAGV_commandArm("cmdArm");
    this.addConnector(CN_cmdArm_49);
    const CN_ackMotor_52 = new CN_ConnectorsAGV_notificationMotor("ackMotor");
    this.addConnector(CN_ackMotor_52);
    const CN_cmdMotor_55 = new CN_ConnectorsAGV_commandMotor("cmdMotor");
    this.addConnector(CN_cmdMotor_55);
    const CN_destinationStation2_58 = new CN_ConnectorsAGV_locationVehicle("destinationStation2");
    this.addConnector(CN_destinationStation2_58);
    const CN_destinationStation_61 = new CN_ConnectorsAGV_locationVehicle("destinationStation");
    this.addConnector(CN_destinationStation_61);
    const CN_command_64 = new CN_ConnectorsAGV_commandArm("command");
    this.addConnector(CN_command_64);
    const CN_command2_67 = new CN_ConnectorsAGV_commandArm("command2");
    this.addConnector(CN_command2_67);
    const CN_currentLocation_70 = new CN_ConnectorsAGV_locationVehicle("currentLocation");
    this.addConnector(CN_currentLocation_70);
    const CN_sendNotificationMotor_73 = new CN_ConnectorsAGV_notificationMotor("sendNotificationMotor");
    this.addConnector(CN_sendNotificationMotor_73);
    const CN_sendNotificationMotor2_76 = new CN_ConnectorsAGV_notificationMotor("sendNotificationMotor2");
