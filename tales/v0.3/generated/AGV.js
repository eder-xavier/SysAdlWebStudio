...
class SysADLArchitecture extends Model {
  constructor(){
    ...
    this.addExecutableSafe("SysADLArchitecture.0jza", "executable CompareStationsEX to CompareStationsAN", []);
    this.addExecutableSafe("SysADLArchitecture.uqfg", "executable ControlArmEX to ControlArmAN", []);
    this.addExecutableSafe("SysADLArchitecture.q9ri", "executable NotifierArmEX to NotifierArmAN", []);
    this.addExecutableSafe("SysADLArchitecture.18pu", "executable NotifyAGVFromMotorEX to NotifyAGVFromMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.iplu", "executable NotifySupervisoryFromMotorEX to NotifySupervisoryFromMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.onm2", "executable PassedMotorEX to PassedMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.r1ie", "executable SendCommandEX to SendCommandAN", []);
    this.addExecutableSafe("SysADLArchitecture.s9xb", "executable SendCurrentLocationEX to SendCurrentLocationAN", []);
    this.addExecutableSafe("SysADLArchitecture.qvwq", "executable SendDestinationEX to SendDestinationAN", []);
    this.addExecutableSafe("SysADLArchitecture.qz2d", "executable SendStartMotorEX to SendStartMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.qiow", "executable StopMotorEX to StopMotorAN", []);
    this.addExecutableSafe("SysADLArchitecture.s4rd", "executable VehicleTimerEX to VehicleTimerAN", []);
