...
class SysADLModel extends Model {
  constructor(){
    ...
    // port current on s1 (expr: this.RTCSystemCFD.s1)
    if (!this.RTCSystemCFD.s1.ports["current"]) { const __p = new Port("current", 'in', { owner: "s1" }); this.RTCSystemCFD.s1.addPort(__p); }
    // port current on s2 (expr: this.RTCSystemCFD.s2)
    if (!this.RTCSystemCFD.s2.ports["current"]) { const __p = new Port("current", 'in', { owner: "s2" }); this.RTCSystemCFD.s2.addPort(__p); }
    // port detected on s3 (expr: this.RTCSystemCFD.s3)
    if (!this.RTCSystemCFD.s3.ports["detected"]) { const __p = new Port("detected", 'in', { owner: "s3" }); this.RTCSystemCFD.s3.addPort(__p); }
    // port desired on ui (expr: this.RTCSystemCFD.ui)
    if (!this.RTCSystemCFD.ui.ports["desired"]) { const __p = new Port("desired", 'in', { owner: "ui" }); this.RTCSystemCFD.ui.addPort(__p); }
    // port controllerC on a2 (expr: this.RTCSystemCFD.a2)
    if (!this.RTCSystemCFD.a2.ports["controllerC"]) { const __p = new Port("controllerC", 'in', { owner: "a2" }); this.RTCSystemCFD.a2.addPort(__p); }
    // port controllerH on a1 (expr: this.RTCSystemCFD.a1)
    if (!this.RTCSystemCFD.a1.ports["controllerH"]) { const __p = new Port("controllerH", 'in', { owner: "a1" }); this.RTCSystemCFD.a1.addPort(__p); }
    // port detectedRTC on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["detectedRTC"]) { const __p = new Port("detectedRTC", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port localtemp1 on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["localtemp1"]) { const __p = new Port("localtemp1", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port localTemp2 on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["localTemp2"]) { const __p = new Port("localTemp2", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port userTempRTC on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["userTempRTC"]) { const __p = new Port("userTempRTC", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port heatingRTC on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["heatingRTC"]) { const __p = new Port("heatingRTC", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port coolingRTC on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["coolingRTC"]) { const __p = new Port("coolingRTC", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port s1 on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["s1"]) { const __p = new Port("s1", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port s2 on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["s2"]) { const __p = new Port("s2", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port average on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["average"]) { const __p = new Port("average", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port target2 on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["target2"]) { const __p = new Port("target2", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port average2 on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["average2"]) { const __p = new Port("average2", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port heating on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["heating"]) { const __p = new Port("heating", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port cooling on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["cooling"]) { const __p = new Port("cooling", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port detected on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["detected"]) { const __p = new Port("detected", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port userTemp on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["userTemp"]) { const __p = new Port("userTemp", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port target on rtc (expr: this.RTCSystemCFD.rtc)
    if (!this.RTCSystemCFD.rtc.ports["target"]) { const __p = new Port("target", 'in', { owner: "rtc" }); this.RTCSystemCFD.rtc.addPort(__p); }
    // port s1 on sm (expr: this.RTCSystemCFD.rtc.sm)
    if (!this.RTCSystemCFD.rtc.sm.ports["s1"]) { const __p = new Port("s1", 'in', { owner: "sm" }); this.RTCSystemCFD.rtc.sm.addPort(__p); }
    // port s2 on sm (expr: this.RTCSystemCFD.rtc.sm)
    if (!this.RTCSystemCFD.rtc.sm.ports["s2"]) { const __p = new Port("s2", 'in', { owner: "sm" }); this.RTCSystemCFD.rtc.sm.addPort(__p); }
    // port average on sm (expr: this.RTCSystemCFD.rtc.sm)
    if (!this.RTCSystemCFD.rtc.sm.ports["average"]) { const __p = new Port("average", 'in', { owner: "sm" }); this.RTCSystemCFD.rtc.sm.addPort(__p); }
    // port target2 on cm (expr: this.RTCSystemCFD.rtc.cm)
    if (!this.RTCSystemCFD.rtc.cm.ports["target2"]) { const __p = new Port("target2", 'in', { owner: "cm" }); this.RTCSystemCFD.rtc.cm.addPort(__p); }
    // port average2 on cm (expr: this.RTCSystemCFD.rtc.cm)
    if (!this.RTCSystemCFD.rtc.cm.ports["average2"]) { const __p = new Port("average2", 'in', { owner: "cm" }); this.RTCSystemCFD.rtc.cm.addPort(__p); }
    // port heating on cm (expr: this.RTCSystemCFD.rtc.cm)
    if (!this.RTCSystemCFD.rtc.cm.ports["heating"]) { const __p = new Port("heating", 'in', { owner: "cm" }); this.RTCSystemCFD.rtc.cm.addPort(__p); }
    // port cooling on cm (expr: this.RTCSystemCFD.rtc.cm)
    if (!this.RTCSystemCFD.rtc.cm.ports["cooling"]) { const __p = new Port("cooling", 'in', { owner: "cm" }); this.RTCSystemCFD.rtc.cm.addPort(__p); }
    // port detected on pc (expr: this.RTCSystemCFD.rtc.pc)
    if (!this.RTCSystemCFD.rtc.pc.ports["detected"]) { const __p = new Port("detected", 'in', { owner: "pc" }); this.RTCSystemCFD.rtc.pc.addPort(__p); }
    // port userTemp on pc (expr: this.RTCSystemCFD.rtc.pc)
    if (!this.RTCSystemCFD.rtc.pc.ports["userTemp"]) { const __p = new Port("userTemp", 'in', { owner: "pc" }); this.RTCSystemCFD.rtc.pc.addPort(__p); }
    // port target on pc (expr: this.RTCSystemCFD.rtc.pc)
    if (!this.RTCSystemCFD.rtc.pc.ports["target"]) { const __p = new Port("target", 'in', { owner: "pc" }); this.RTCSystemCFD.rtc.pc.addPort(__p); }
    // ensure activity ports for s1 (expr: this.RTCSystemCFD.s1)
    // ensure activity ports for s2 (expr: this.RTCSystemCFD.s2)
    // ensure activity ports for s3 (expr: this.RTCSystemCFD.s3)
    // ensure activity ports for ui (expr: this.RTCSystemCFD.ui)
    // ensure activity ports for a2 (expr: this.RTCSystemCFD.a2)
    // ensure activity ports for a1 (expr: this.RTCSystemCFD.a1)
    // ensure activity ports for rtc (expr: this.RTCSystemCFD.rtc)
    // ensure activity ports for sm (expr: this.RTCSystemCFD.rtc.sm)
    // ensure activity ports for cm (expr: this.RTCSystemCFD.rtc.cm)
    // ensure activity ports for pc (expr: this.RTCSystemCFD.rtc.pc)
    // ensure activity ports for s1 (expr: this.RTCSystemCFD.s1)
    // ensure activity ports for s2 (expr: this.RTCSystemCFD.s2)
    // ensure activity ports for s3 (expr: this.RTCSystemCFD.s3)
    // ensure activity ports for ui (expr: this.RTCSystemCFD.ui)
    ...
    this.addExecutableSafe("SysADLModel.n80b", "executable FahrenheitToCelsiusEx to FahrenheitToCelsiusAN", []);
    this.addExecutableSafe("SysADLModel.w6ix", "executable CompareTemperatureEx to CompareTemperatureAN", []);
    this.addExecutableSafe("SysADLModel.rnyl", "executable CommandHeaterEx to CommandHeaterAN", []);
    this.addExecutableSafe("SysADLModel.ccbr", "executable CommandCoolerEx to CommandCoolerAN", []);
    this.addExecutableSafe("SysADLModel.xefu", "executable CheckPresenceToSetTemperature to CheckPeresenceToSetTemperatureAN", []);
    this.addExecutableSafe("SysADLModel.mued", "executable CalculateAverageTemperatureEx to CalculateAverageTemperatureAN", []);
