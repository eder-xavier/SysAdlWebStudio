...
class SysADLModel extends Model {
  constructor(){
    ...
    this.addExecutableSafe("SysADLModel.k0xe", "executable FarToCelEX to FarToCelAN", []);
    this.addExecutableSafe("SysADLModel.xi8z", "executable CalcAverageEX to TempMonitorAN", []);
