...
class SysADLModel extends Model {
  constructor(){
    ...
    this.addExecutableSafe("SysADLModel.ewkc", "executable FarToCelEX to FarToCelAN", []);
    this.addExecutableSafe("SysADLModel.k86d", "executable CalcAverageEX to TempMonitorAN", []);
